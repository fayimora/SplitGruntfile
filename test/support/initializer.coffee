...
Ember.testing = true
Splitgruntfile.rootElement = "#ember-testing"
Ember.Test.adapter = Ember.Test.MochaAdapter.create()

Splitgruntfile.setupForTesting()
Splitgruntfile.injectTestHelpers()
Ember.run Splitgruntfile, Splitgruntfile.advanceReadiness
